    ...
    return Observer(builder: (_) => ToolButton(
      ...
      flyoutBuilder: (context) => FlyoutContent(
        ...
        child: Observer(builder: (_) => IntrinsicWidth(child: Column(
          ...
          children: [
            StrokePresetRow(
              presets: kPenWidthPresets,
              value: viewModel.drawingTools.penWidth,
              onPresetSelected: controller.onPenWidthChanged,
            ...
            Row(
              ...
              children: [
                ...
                SizedBox(
                  height: 24,
                  child: Slider(min: 2, max: 64, value: viewModel.drawingTools.penWidth, onChanged: controller.onPenWidthChanged),
                ),
                Container(
